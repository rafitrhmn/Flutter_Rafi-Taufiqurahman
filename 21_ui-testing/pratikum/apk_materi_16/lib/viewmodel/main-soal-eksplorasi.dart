...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> sendData() async {
    try {
      String name = nameController.text;
      int nohp = int.tryParse(NohpController.text) ?? 0;

      String apiUrl =
          'https://my-json-server.typicode.com/hadihammurabi/flutter-webservice/contacts/3';
  ...
  @override
  Widget build(BuildContext context) {
    Key nameFieldKey = Key('nameField');
    Key phoneFieldKey = Key('phoneField');
